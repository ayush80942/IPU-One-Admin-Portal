...
export default function CoursesPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Courses"
        subtitle={`Code and name are kept in sync automatically from imported results — set the total semester count here, since it drives each student's "Pass Out" status.`}
      />
